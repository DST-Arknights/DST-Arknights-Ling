...
local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 211, 151, 64) },
            { .2,   IntColour(255, 211, 151, 240) },
            { .7,   IntColour(255, 211, 151, 256) },
            { 1,    IntColour(255, 211, 151, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 211, 151, 64) },
            { .2,   IntColour(255, 211, 151, 256) },
            { .75,  IntColour(255, 211, 151, 256) },
            { 1,    IntColour(255, 211, 151, 0) },
        }
    )
...
return Prefab("ling_lantern_smoke", fn, assets)
