TUNING.LING.ELITE = {{
  MAX_HEALTH_MODIFIED = -100,
  MAX_HUNGER = 150,
  MAX_SANITY = 250,
  MAX_POETRY = 30,
  POETRY_RECOVERY_WHILE_IDLE_PER_SECOND = 10 / 60, -- 每分钟恢复5诗意
  POETRY_RECOVERY_IN_DREAM_BONUS = 1.2, -- 每秒恢复诗意
  MAX_GUARDS = 3,
  ...
  -- 被动攻击增加百分比
  SO_IS_WRIT_AN_ODE_TO_WINE_BUFF_INCREASE_ATTACK_PERCENT = 1.02,
}, {
  MAX_HEALTH_MODIFIED = -80,
  MAX_HUNGER = 150,
  MAX_SANITY = 250,
  MAX_POETRY = 60,
  POETRY_RECOVERY_WHILE_IDLE_PER_SECOND = 15 / 60,
  POETRY_RECOVERY_IN_DREAM_BONUS = 1.4,
  MAX_GUARDS = 4,
  ...
  MAX_SANITY = 300,
  MAX_POETRY = 100,
  POETRY_RECOVERY_WHILE_IDLE_PER_SECOND = 20 / 60,
  POETRY_RECOVERY_IN_DREAM_BONUS = 1.6,
  MAX_GUARDS = 5,
  DAMAGE_MULTIPLIER = 1,
  SPEED_MULTIPLIER = 1,
  SLEEP_RESISTANCE = 1.1,
  SO_IS_WRIT_AN_ODE_TO_WINE_BUFF_DURATION = 20,
