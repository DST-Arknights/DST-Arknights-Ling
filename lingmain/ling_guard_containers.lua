...
containers.params.ling_guard_plant_container = {
  widget = {
    ...
    pos = Vector3(unpack(CONSTANTS.LING_GUARD_PANEL_POSITION)) + Vector3(unpack(CONSTANTS.LING_GUARD_PANEL_PLANT_CONTAINER_POSITION)) * CONSTANTS.LING_GUARD_PANEL_SCALE,
    side_align_tip = 120,
    skipopensnd = true,
    skipclosesnd = true,
    animPos = Vector3(0, 0, 0),
  },
